...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_img_dir', type=str, default='/media/data2/zhangcheng/data/TrainDataset/Imgs/')
    parser.add_argument('--train_gt_dir',  type=str, default='/media/data2/zhangcheng/data/TrainDataset/GT/')
    parser.add_argument('--train_eg_dir',  type=str, default='/media/data2/zhangcheng/data/TrainDataset/Edge/')
    
    parser.add_argument('--test_img_dir',  type=str, default='/media/data2/zhangcheng/data/TestDataset/CAMO/Imgs/')
    parser.add_argument('--test_gt_dir',   type=str, default='/media/data2/zhangcheng/data/TestDataset/CAMO/GT/')
    parser.add_argument('--test_eg_dir',   type=str, default='/media/data2/zhangcheng/data/TestDataset/CAMO/Edge/')
